...
class FooTest < Test::Unit::TestCase
  ...
  def test_should_return_a_range_from_six_through_66_when_sent_bar
    assert_equal 6..66, @foo.bar
  end
  
  def test_should_return_a_range_from_seven_to_and_excluding_77_when_sent_baz
    assert_equal 7...77, @foo.baz
  end
