...
no_method_errors_count = 0
Dir.glob(File.expand_path("#{File.dirname __FILE__}/input/**/*.rb")) do |source_file|
  begin
    require File.expand_path(source_file)
  rescue NoMethodError
    no_method_errors_count += 1
  end
end
unless no_method_errors_count == 2
  raise Test::Unit::AssertionFailedError,
        "expected NoMethodError to be raised once but happened #{no_method_errors_count} time(s)"
end
