...
class Test_ < Test::Unit::TestCase
  ...
  def test_should_return_true_when_sent_bar
    assert_equal true, Test_.top_level_method_calls[:bar].call
  end
  
  def test_should_return_true_when_sent_foo
    assert_equal true, Test_.top_level_method_calls[:foo].call
  end
